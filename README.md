...
- **Performance.** 151,000 files indexed in 41 seconds (v0.47.0, production PHP site), sub-ms search per query. Production-grade for 100K+ file monorepos.
