...
Всё это без скриптов, по шагам: [установка вручную](docs/manual-install.md)
([English](docs/manual-install_EN.md)).
...
Настройка — в [полном руководстве](README_RU.md#настройка-фонового-демона-v05).
