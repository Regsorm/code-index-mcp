...
> **Ключевые метрики:** 62K файлов за 43 сек · 282K функций за <1 мс · 8 языков · 11 MCP-инструментов
...
Субагенты (Agent tool в Claude Code) не имеют доступа к MCP-серверам. Все 11 MCP-инструментов продублированы как CLI-подкоманды с JSON-выводом — это позволяет использовать code-index из любого подпроцесса или скрипта.
...
1. **Startup scan** — индексирует новые и изменённые файлы при старте
