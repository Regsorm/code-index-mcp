...
| `get_call_tree` | **(v0.23.0)** Дерево вызовов от функции вниз/вверх (`direction=callees\|callers`, `max_depth`, `max_nodes`). Для 1С вверх — с вызовами с квалификатором, вниз — по привязке графа |
