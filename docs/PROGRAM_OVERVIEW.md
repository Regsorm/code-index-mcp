...
- `bsl-indexer` — приватный, включает всё из `code-index` плюс 13 BSL-специфичных MCP-инструментов для конфигураций 1С:Предприятие.
